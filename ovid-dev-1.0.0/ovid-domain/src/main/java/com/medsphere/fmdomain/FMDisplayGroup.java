...
public class FMDisplayGroup extends FMRecord {
    ...
    @FMAnnotateFieldInfo( name="MIXED NAME", number="2", fieldType=FMField.FIELDTYPE.FREE_TEXT)
    protected String mixedName;
    @FMAnnotateFieldInfo( name="SHORT NAME", number="3", fieldType=FMField.FIELDTYPE.FREE_TEXT)
