...
FGMenu.prototype.setPosition = function(widget, caller, options) { 
	...
	//Need to force the z-index high, otherwise is hidden behind layout
	helper.css({ position: 'absolute', 'z-index':'100', left: dims.refX, top: dims.refY, width: dims.refW, height: dims.refH});
	el.wrap(helper);
