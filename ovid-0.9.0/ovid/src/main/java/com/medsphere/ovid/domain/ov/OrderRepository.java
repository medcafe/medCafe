...
public class OrderRepository extends OvidSecureRepository {
    ...
    public OrderRepository(VistaLinkConnection connection) {
        super(connection);
    }
    ...
    private void testGetBigListsOfThings(VistaLinkPooledConnection conn) throws OvidDomainException {
...
//            conn.close();
    ...
    public static void main(String[] main) throws OvidDomainException, GenericCacheException {
