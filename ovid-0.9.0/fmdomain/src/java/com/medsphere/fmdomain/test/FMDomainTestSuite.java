...
import com.medsphere.adapter.VistaLinkResAdapter;
...
//    private final String fmFilemanResource = "MSC FILEMAN RESOURCE";
   ...
   @AfterClass
    public void tearDown() {
 	...
 	@Test
    private void testIndexList() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testDictionarySubfile() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testDictionaryToplevel() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testFileList() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testFileInfo() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testFileInfoForSubfiles() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testRetrieveSubfileCount() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testRetrieveUserInfo() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testGetWPField() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testRetrieveVP() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    //@Test
    private void testRetrieve() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    //@Test
    private void testRetrieveOneField() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testRetrieveNondomain() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    //@Test
    private void testListSubfiles() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testListSubfilesNondomain() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testInsertSubfiles() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testInsertSubfilesNondomain() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testUpdateDrugInvalid() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testUpdateDrug() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testUpdateNondomain() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    //@Test
    private void testUpdatePointer() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testInsertThenDeleteDrug() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    // TODO: not working...
    //@Test
    private void testUpdateSubfile( ) throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testUpdateSubfileNondomain() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testListNondomain() throws ResException {
    ...
    //@Test
    private void testListNondomainWithScreen() throws ResException {
    ...
    @Test
    private void testListMultiple() throws ResException {
    ...
    @Test
    private void testListNondomainWithWP() throws ResException {
    ...
    @Test
    private void testListNondomainWithVP() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testListDomain() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    @Test
    private void testShowDrugMessages() throws ResException {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection, fmResourceUser, fmFilemanResource );
    ...
    private static void testDeleteSubfile(VistaLinkPooledConnectionFactory factory ) {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection,
                "MSC FM RESOURCE USER", "MSC FILEMAN RESOURCE" );
        FMDelete delete = new FMDelete( adapter );
        FMDrug drug = new FMDrug();
        drug.setIEN( "2" );
        FMDrugSynonym synonym = new FMDrugSynonym();
    ...
    private static void testDeleteSubfileNondomain(VistaLinkPooledConnectionFactory factory ) {
        VistaLinkPooledConnection connection = factory.getConnection();
        VistaLinkResAdapter adapter = new VistaLinkResAdapter( connection,
                "MSC FM RESOURCE USER", "MSC FILEMAN RESOURCE" );
        FMDelete delete = new FMDelete( adapter );
