...
public class FMTIUDocumentHeader extends FMRecord {
    ...
    @FMAnnoteFieldInfo( name="DOCUMENT TYPE", number=".01", fieldType=FMField.FIELDTYPE.POINTER_TO_FILE)
    private Integer documentTypeID;
    @FMAnnoteFieldInfo(name="AUTHOR/DICTATOR", number="1202", fieldType=FMField.FIELDTYPE.POINTER_TO_FILE)
    private Integer authorID;
    @FMAnnoteFieldInfo( name="REFERENCE DATE", number="1301", fieldType=FMField.FIELDTYPE.DATE)
