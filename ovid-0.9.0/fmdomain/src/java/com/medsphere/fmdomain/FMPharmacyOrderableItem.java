 ...
 * 
 */
public class FMPharmacyOrderableItem extends FMRecord {
    /*-------------------------------------------------------------
    ...
    public FMPharmacyOrderableItem() {
        super(fileInfo.getFileName());        
    }

    public FMPharmacyOrderableItem(FMResultSet results) {
        super(results);
    }
