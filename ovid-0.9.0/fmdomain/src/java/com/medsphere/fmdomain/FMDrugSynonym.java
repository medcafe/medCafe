...
public class FMDrugSynonym extends FMRecord {
    ...
    @FMAnnoteFieldInfo( name="SYNONYM", number=".01", fieldType=FMField.FIELDTYPE.FREE_TEXT)
    private String synonym;
    @FMAnnoteFieldInfo( name="NDC CODE", number="2", fieldType=FMField.FIELDTYPE.FREE_TEXT)
    private String ndcCode;
    @FMAnnoteFieldInfo( name="INTENDED USE", number="1", fieldType=FMField.FIELDTYPE.SET_OF_CODES)
