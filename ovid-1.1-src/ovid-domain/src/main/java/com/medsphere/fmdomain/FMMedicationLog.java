...
public class FMMedicationLog extends FMRecord {
    ...
    @FMAnnotateFieldInfo(name = "DISPENSE DRUG", number = ".5", fieldType = FMField.FIELDTYPE.SUBFILE)
    protected FMMedicationLogDispenseDrug dispenseDrugFile;

    protected Collection<FMMedicationLogDispenseDrug> dispenseDrugs;
    ...
    public FMMedicationLogDispenseDrug getDispenseDrugFile() {
        if (dispenseDrugFile == null) {
            dispenseDrugFile = new FMMedicationLogDispenseDrug();
            dispenseDrugFile.setParent(this);
        }
        
        return dispenseDrugFile;
    }

    public void addDispenseDrug(FMMedicationLogDispenseDrug dispenseDrug) {
        if (dispenseDrugs == null)
            dispenseDrugs = new ArrayList<FMMedicationLogDispenseDrug>();

        dispenseDrugs.add(dispenseDrug);

    }

    public Collection<FMMedicationLogDispenseDrug> getDispenseDrugs() {
