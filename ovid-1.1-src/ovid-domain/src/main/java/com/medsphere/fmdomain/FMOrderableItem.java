...
public class FMOrderableItem extends FMRecord  {
    ...
    public String toString() {
        return ""
            ...
            + ((getInactivatedDate() != null) ? " inactivatedDate=[" + getInactivatedDate()  + "]" : "")
            + ((getPackageName() != null) ? " packageName=[" + getPackageName()  + "]" : "")
            + ((getId() != null) ? " id=[" + getId()  + "]" : "")
            + ((getDisplayGroup() != null) ? " displayGroup=[" + getDisplayGroup()  + "]" : "")
            + ((getLabSection() != null) ? " labSection=[" + getLabSection()  + "]" : "")
        ;
