 ...
 * @author mark.taylor
 */
public class FMOutpatientOrderCheck extends FMRecord {
    /*-------------------------------------------------------------
    ...
    static {
        domainJavaFields = getDomainJavaFields(FMOutpatientOrderCheck.class);
        domainFields = getFieldsInDomain(domainJavaFields);
        domainNumbers = getNumericMapping(FMOutpatientOrderCheck.class);
        fileInfo = new FMFile("ORDERS CHECKS") {
    ...
    public FMOutpatientOrderCheck() {
        super("ORDERS CHECKS");
    }

    public FMOutpatientOrderCheck(FMResultSet results) {
        super( results );
    }
