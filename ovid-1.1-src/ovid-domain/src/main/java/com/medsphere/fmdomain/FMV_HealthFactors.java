...
/*
 * container class of fileman V Health Factors information
 */
...
public class FMV_HealthFactors extends FMRecord {
    ...
    @FMAnnotateFieldInfo(name = "HEALTH FACTOR", number = ".01", fieldType = FMField.FIELDTYPE.POINTER_TO_FILE)
    protected Integer healthFactor;
    ...
    @FMAnnotateFieldInfo(name = "LEVEL/SEVERITY", number = ".04", fieldType = FMField.FIELDTYPE.SET_OF_CODES)
    protected String levelSeverity;
    ...
    public FMV_HealthFactors() {
        super(fileInfo.getFileName());


    }

    public FMV_HealthFactors(FMResultSet results) {
        super(results);
    }
    public Integer getHealthFactor (){
        return healthFactor;
    }
    public String getHealthFactorValue()
    {
        return getValue(".01");
    }
    ...
    public String toString() {
        ...
        + " health factor =["+getHealthFactorValue()+"]"
        + " level/severity =["+ getLevelSeverity() + "]"
