 ...
 * 
 */
public class DrugCache extends GenericCache<String,FMDrug> {

    private static DrugCache instance = null;
    ...
    public static synchronized DrugCache getInstance() {
        if (instance == null) {
            instance = new DrugCache();
