...
public abstract class GenericCache<K, V> implements Comparable {
    ...
    private Logger logger = LoggerFactory.getLogger(GenericCache.class);
    ...
    private boolean automaticallyRefreshValuesWhenFetched = true;
    ...
    public V getByKey(K key) throws GenericCacheException {
        ...
        } else if (automaticallyRefreshValuesWhenFetched){
            shelfLifeMap.put(key, System.currentTimeMillis());
        }
        return value;
    }
    ...
    public Collection<V> getCacheValues() throws GenericCacheException {
        ...
        if (automaticallyRefreshValuesWhenFetched) {
    ...
    protected void setAutomaticallyRefreshValuesWhenFetched(boolean v) {
        automaticallyRefreshValuesWhenFetched = v;
    }
}
