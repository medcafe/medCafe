...
import org.mitre.medj.jaxb.ContinuityOfCareRecord.Body.Procedures;
...
public class PatientProcedureResource extends MedJResource {
   ...
   /**
    ...
    public JsonRepresentation toJson(){
    	...
    	try {
    		...
    		Procedures procedures = ccr.getBody().getProcedures();
    		System.out.println("PatientProceduresResource: procedures " + procedures);
	        if (procedures == null)
	        {
	        	return new JsonRepresentation(WebUtils.buildErrorJson( "No Procedures found" ) );  
	        }
    		Gson gson = new Gson();
	        if ( ccr!= null)
            {
            	String jsonString = gson.toJson(procedures);
