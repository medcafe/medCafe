...
public class PatientProblemsResource extends MedJResource {

    public final static String KEY = PatientProblemsResource.class.getName();
   ...
   /**
    ...
    public JsonRepresentation toJson(){
    	...
    	try {
    		...
    		Problems problems = ccr.getBody().getProblems();
    	   if (problems == null)
	        {
	        	return new JsonRepresentation(WebUtils.buildErrorJson( "No Problems found" ) );  
	        }
    		Gson gson = new Gson();
	        if ( ccr!= null)
            {
