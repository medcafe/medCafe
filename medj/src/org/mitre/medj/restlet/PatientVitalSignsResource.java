...
import org.mitre.medj.jaxb.ContinuityOfCareRecord.Body.VitalSigns;
...
public class PatientVitalSignsResource extends MedJResource {

    public final static String KEY = PatientVitalSignsResource.class.getName();
   ...
   /**
    ...
    public JsonRepresentation toJson(){
    	...
    	try {
    		...
    		VitalSigns vSigns = ccr.getBody().getVitalSigns();
    		System.out.println("PatientProceduresResource: VitalSigns " + vSigns);
	        if (vSigns == null)
	        {
	        	return new JsonRepresentation(WebUtils.buildErrorJson( "No Vital Signs found" ) );  
	        }
    		Gson gson = new Gson();
	        if ( ccr!= null)
            {
            	String jsonString = gson.toJson(vSigns);
