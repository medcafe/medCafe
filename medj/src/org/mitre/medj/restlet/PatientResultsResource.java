...
import org.mitre.medj.jaxb.ContinuityOfCareRecord.Body.Results;
...
public class PatientResultsResource extends MedJResource {
   ...
   /**
    ...
    public JsonRepresentation toJson(){
    	...
    	try {
    		...
    		Results res = ccr.getBody().getResults();
