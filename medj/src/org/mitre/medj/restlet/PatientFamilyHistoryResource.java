...
public class PatientFamilyHistoryResource extends MedJResource {

    public final static String KEY = PatientFamilyHistoryResource.class.getName();
   ...
   /**
    ...
    public JsonRepresentation toJson(){
    	...
    	try {
    		...
    		FamilyHistory familyH = ccr.getBody().getFamilyHistory();
    		System.out.println("PatientFamilyResource: familyH " + familyH);
	        if (familyH == null)
	        {
	        	return new JsonRepresentation(WebUtils.buildErrorJson( "No Family History found" ) );  
	        }
    		Gson gson = new Gson();
	        if ( ccr!= null)
            {
            	String jsonString = gson.toJson(familyH);
