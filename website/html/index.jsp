...
<jsp:include page="nav.html"/>
    <div id="main">
		<div id="content">
            ...
            <br/>
            <b>medCafe demonstrates how to change the way clinicians view health care records</b></p>
            ...
            <h3>medCafe Approach: Advantages for the Practice</h3>
            <p>
            <ul>
            	<li>Can start small, grow functionality over time focusing on the capability practice cares about</li>
            	...
            	<li>System completely adaptable to changing practice circumstances</li>
            	...
            	<li><b>Demonstrates a more effective way to build a system a practice needs</b></li>
