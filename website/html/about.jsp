...
<jsp:include page="nav.html"/>
    ...
    <div id="main">
		<div id="fullcontent">
            ...
            <p><a href="images/coverflow.png"><img src="images/coverflow.png" style="float:left;width:246px;height:107px;" alt="picture of coverflow widget"/></a>For some physicians, imagery and external records are a problem.  The files themselves are accessible, but it takes 30+ seconds to retrieve one.  To compound this, the imagery isn't labeled usefully, so many images have to be checked.  We show a way to pre-filter these images, then display only those in a way that let's the user "flip through" the thumbnails similar to flipping through a stack of papers.  Only when something looks promising does the full image come up, saving time and resources.</p>
			<h4>Timeline</h4>
